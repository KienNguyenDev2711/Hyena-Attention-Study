...
Ở độ dài 8192, Hyena nhanh hơn attention tối ưu của PyTorch 1,88 lần cho lượt
tiến và lùi. Tiếng Việt mang thông tin tương hỗ cục bộ gấp 1,7 đến 2,3 lần
...
log một cách có ý nghĩa. Bộ lọc suy từ hai ngôn ngữ gần nhau theo quy ước ánh
xạ đang dùng (lệch 14,3\%) nhưng xa nhau hơn khi tính bề rộng ô (36,2\%), nên
câu hỏi bộ lọc có mang tính đặc thù ngôn ngữ hay không vẫn còn mở.
\end{abstract}
...
đặc thù ngôn ngữ. Phép thử trực tiếp là hoán đổi $\alpha$ giữa hai ngôn ngữ khi
huấn luyện, chúng tôi chưa thực hiện. Mọi số trong mục này được tái sinh bởi
...
Bài báo gốc khẳng định Hyena đạt chất lượng \emph{tương đương} Transformer ở
quy mô 125 đến 355 triệu tham số; kết quả của chúng tôi thuộc một chế độ khác,
mô hình nhỏ và ngân sách ngắn, nên không mâu thuẫn với khẳng định đó. Cần đọc
thận trọng vì hai lý do. Cả hai kiến trúc dùng chung learning rate và lịch huấn
...
Từ mục này, mọi so sánh perplexity dùng một tiêu chí: kiểm định Welch hai mẫu,
hiệu chỉnh Holm trong từng họ so sánh ở mức 0,05. Khoảng tin cậy trong bảng chỉ
để mô tả; hai khoảng chồng lấn không đồng nghĩa với không có khác biệt.
...
Câu hỏi bộ lọc có đặc thù ngôn ngữ hay không thì chưa được trả lời. Theo quy ước
ánh xạ đang dùng, hai bộ lọc gần nhau; đổi quy ước thì khoảng cách tăng 2,5 lần;
còn perplexity quá ít nhạy với $\alpha$ để phân biệt. Bài học phương pháp là một
kết luận rút từ hình dạng bộ lọc phải được kiểm lại ở mức huấn luyện, ở đây là
bằng cách hoán đổi $\alpha$ giữa hai ngôn ngữ.
...
đến 2,3 lần có thể chịu ảnh hưởng của nó. Chúng tôi cũng chưa chạy thí nghiệm
hoán đổi $\alpha$ giữa hai ngôn ngữ và seed thứ ba cho ablation.
...
thang log, và câu hỏi bộ lọc có đặc thù ngôn ngữ hay không phụ thuộc quy ước ánh
xạ, cần thí nghiệm hoán đổi $\alpha$ để trả lời. Chúng tôi báo cáo các kết quả
